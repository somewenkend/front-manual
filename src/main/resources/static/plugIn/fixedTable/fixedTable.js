 ...
 */
function FixedTable(tableId, height, fixedCount) {
...
FixedTable.prototype = {
	...
	buildHtml: function(height) {
		...
		// 拼表格父级结构
		var tableParentHtml = `
			<div id="table-view-` + this.tableId + `" class="table-view" style="max-height: `+ height +`px">
			</div>
		`;
